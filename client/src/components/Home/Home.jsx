...
import user4 from "../images/testimonial-1.jpg"
import user5 from "../images/testimonial-2.jpg"
import user6 from "../images/testimonial-3.jpg"
import user7 from "../images/testimonial-4.jpg"
import user8 from "../images/testimonial-5.jpg"
import user9 from "../images/testimonial-6.jpg"
...
function  Home () {
  ...
  const {name,phone,email,select} = data
...
document.getElementById('check').value=""
  e.preventDefault()
  try{
    await axios.post("/user",{name,phone,email,select})    
    }
...
/*------------------------------------------------------------*/
        return (
            <div>
                <Navbar />
                <ScrollToTop smooth top="20"  color="#14BF98" />
     ...
     <p>     At Aria solutions, we’ve taken the consultancy <br />
      ...
      >
        ...
        <SwiperSlide>
          ...
          <div className="swiper-box">
          <img src={user8} alt='user'/>
          <p>My goals for using Aria's services seemed high when I first set them but they've met them with no problems.</p>
          <h3>Ann Black - Consultant</h3>
          </div>
          <div className="swiper-box swiper-2">
          <img src={user9} alt='user'/>
          <p>My goals for using Aria's services seemed high when I first set them but they've met them with no problems.</p>
          <h3>Ann Black - Consultant</h3>
          </div>
                ...
                <section className="call">
                  ...
                  <div className="call-infos">
                    ...
                    <p className="ptag">You are just a few steps away from a personalized offer. Just fill<br /> in the form and send it to us and we'll get right back with a call<br /> to help you decide what service package works.</p>
                  ...
                  <div className="call-form">
                    <form onSubmit={handleSubmit}>
                      <input onChange={handleChange} value={name} name="name" id="name"  type="text" placeholder="Name"/><br />
                      <input onChange={handleChange}  value={phone} name="phone" id="phone" type="text" placeholder="Phone"/><br />
                      <input onChange={handleChange} value={email} name="email" id="email"  type="text" placeholder="Email"/><br />
                     <select onChange={handleChange}  value={select} name="select"  >
                        <option  value disabled selected >interssted in</option>
                        <option value="off the gound" name="select" >off the gound</option>
                        <option value="accelerated growth" name="select">accelerated growth</option>
                        <option value="market domination" name="select">market domination</option>
                      </select> 
                      <pre>Sélectionnez un élément dans la liste.</pre>
                       <input  type="checkbox" id="check"  required="" />  <span>I agree with Aria's stated Privacy Policy and Terms & Conditions</span><br /> 
